...
public class BookApp {
	...
	public static void main(String[] args) {
		...
		/***************************** 수정&삭제 테스트
		//수정 테스트
		AuthorVo uAuthorVo = new AuthorVo(4, "차예진", "응암동 불주먹");
		authorDao.authorUpdate(uAuthorVo);
		
		BookVo uBookVo = new BookVo("말하는 감자", "포테이토", "2021-07-04", 4, 5);
		...
		//삭제 테스트
		int dCount = authorDao.authorDelete(1);
		...
		********************************/
		...
		/*BookDao의 메소드에서 스캐너 사용하는 방법
	    bookSearchList = bookDao.bookSearch();
		//리스트를 for문으로 출력 --> 메소드로 정의
		printList(bookSearchList);
		*/
